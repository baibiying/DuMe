...
「专注币」可演进为链上代币，结合钱包领取、连续专注奖励、排行榜/成就结算。
...
### 6.5 Token integration 

Focus coins may evolve into an on-chain token, with wallet claiming, streak rewards, and leaderboard/achievement settlement. 
